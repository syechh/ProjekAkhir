...
if(isset($_POST['tambah'])){
    ...
    $sql = "INSERT INTO pembelian (tanggal, id_barang, nama_supplier, qty, harga_beli_satuan, total_harga) VALUES ('$tanggal', '$id_barang','$supplier', '$qty', '$harga', '$total')";
    mysqli_query($con,$sql);
    $query = "UPDATE barang SET stok =  stok + $qty WHERE id = '$id_barang'";
    mysqli_query($con,$query);
    if($sql && $qty){
        echo "<alert>berhasil menambahkan stok barang</alert>";
    }else{
        echo "<alert>gagal menambahkan barang</alert>";
    }
}
